...
namespace FNS_rebuild
{
    ...
    internal static class Encryption_core_catalog
    {
        ...
        internal const string Kuznyechik_ctr_id = "kuznyechik-ctr-gost-r-34-12-2015";
        internal const string Aes_gcm_id = "aes-gcm-256";

        internal const string Factorial_display_name = "Факториальная система счисления";
        internal const string Kuznyechik_ctr_display_name = "Кузнечик-CTR (ГОСТ Р 34.12-2015 / ГОСТ Р 34.13-2015)";
        ...
        internal static string To_storage_id(Encryption_core_kind core)
        {
            return core switch
            {
                Encryption_core_kind.KuznyechikCtr => Kuznyechik_ctr_id,
        ...
        internal static Encryption_core_kind From_storage_id(string? value)
        {
            ...
            if (string.Equals(normalized, Kuznyechik_ctr_id, StringComparison.OrdinalIgnoreCase))
                return Encryption_core_kind.KuznyechikCtr;
